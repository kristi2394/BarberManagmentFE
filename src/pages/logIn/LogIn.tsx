...
const Login = () => {
  const [userName, setUserName] = useState<{valueButton: string, rols: string}>({
    valueButton: '',
    rols: ''
  });
  ...
  return (
    <div className={styles.loginContainer}>
      <div className={styles.userHolder}>
        <div className={styles.logoAndUsers}>
          <div className={styles.logoName}>
            <BarberShopLogo/>
            <h1><span>Title</span> Of <span>Bussiness</span></h1>
          </div>
        <ul>
      ...
      <div className={styles.loginHolder}>
        <LoginUser userName={userName.valueButton} rols={userName.rols} focusRef={focusRef} />
      </div>
    </div>
  );
};
